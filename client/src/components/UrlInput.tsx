...
/**
 * Komponenta pro zadání URL restaurace
 * Obsahuje formulář s validací a loading stavem
 */
const UrlInput: React.FC<UrlInputProps> = ({ onSubmit, isLoading, isCentered }) => {
  ...
  return (
    <form
      ...
      className={`w-full max-w-lg p-8 bg-zinc-800/70 backdrop-blur-lg rounded-xl shadow-xl transition-all duration-300 ${isCentered ? 'scale-100' : 'scale-95'}`}
    >
      {/* Popisek pro input pole */}
